...
const Section: React.FC<DashboardBranchSectionProps> = ({ title, branches, onDeleteBranch, isDeleting, onEditBranch }) => {
  return (
    <div className="space-y-4 border border-background2/60 p-5 rounded-2xl bg-background2 shadow-inner">
      {title && (
        <div className="flex items-center gap-2 border-b border-background2 pb-2">
          ...
          <span className="text-xs bg-primary text-accent px-4 py-0.5 rounded-full font-sans">
